...
public class SEALUtils
{
    ...
    public static RelinKeys BuildRelinKeysFromBase64String(string base64, SEALContext context)
    {
        var payload = Convert.FromBase64String(base64);
    ...
    public static string KeyToBase64String(PublicKey publicKey)
    {
        using var ms = new MemoryStream();
        publicKey.Save(ms);
        return Convert.ToBase64String(ms.ToArray());
    ...
    public static string KeyToBase64String(RelinKeys relinKeys)
    {
        using var ms = new MemoryStream();
        relinKeys.Save(ms);
        return Convert.ToBase64String(ms.ToArray());
